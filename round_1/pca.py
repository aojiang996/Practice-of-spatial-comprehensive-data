...
def PCA(file_1, file_2):
    ...
    result.save("C:/Desktop" + str("/PCA融合结果图.png"))

def main():
    rgb_file_path = "D:/01近期文档/空科综合实习内容一（gis-rs）候选题目/01次实验/mif.tif"
    b_8_file_path = "D:/01近期文档/空科综合实习内容一（gis-rs）候选题目/01次实验/B8.tif"
